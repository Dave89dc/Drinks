...
@Component({
  selector: 'app-random-non-alcoholic-drink',
  templateUrl: './random-non-alcoholic-drink.component.html',
  styleUrls: ['./random-non-alcoholic-drink.component.scss']
})
export class RandomNonAlcoholicDrinkComponent implements OnInit {
  ...
  randomView: RandomDrinkView = {
    randomTitlePageEN: 'Random "Non" Alcoholic Drink',
    randomTitlePageES: 'Bebida "No" Alcohólica al Azar',
    randomTitlePageDE: 'Zufälliges "Alkoholfreie" Getränk',
    randomTitlePageFR: 'Boisson "Non" Alcoolisée Aléatoire',
    randomTitlePageIT: 'Bevanda Non Alcolica Casuale',
  ...
  ngOnInit(){
    if(this.language.valueChanges){
      this.language.valueChanges.subscribe(newValue => {
        this.randomNonAlcoholicDrinkDetailsIfChangeLanguage();
    });
    }
    this.loadRandomNonAlcoholicDrinkDetails();
  }

  loadRandomNonAlcoholicDrinkDetails(){
    this.loading = true;
    this.instructions = '';
    this.ingredients = [];
    this.measures = [];
    this.dataService.getRandomDrink().subscribe({
      next: drinkDetails => {
        if(drinkDetails.strAlcoholic === 'Non alcoholic'){
  ...
  randomNonAlcoholicDrinkDetailsIfChangeLanguage(){
    this.instructionsEN = '';
    this.instructionsES = '';
    this.instructionsDE = '';
    this.instructionsFR = '';
