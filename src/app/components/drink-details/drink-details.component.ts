...
import { DrinkDetailsView } from 'src/app/models/drinkDetailsView';
...
export class DrinkDetailsComponent implements OnInit {
  ...
  drinkId = this.route.snapshot.paramMap.get('id');
  drinkName = this.route.snapshot.paramMap.get('name');
  ...
  drinkDetailsView: DrinkDetailsView = {
    detailsTitleEN: "Drink Details",
    detailsTitleES: "Detalles De La Bebida",
    detailsTitleDE: "Getränkedetails",
    detailsTitleFR: "Détails De La Boisson",
    detailsTitleIT: "Dettagli Sulla Bevanda",
    detailsCategoryEN: 'Category: ',
    detailsCategoryES: 'Categoría: ',
    detailsCategoryDE: 'Kategorie: ',
    detailsCategoryFR: 'Catégorie : ',
    detailsCategoryIT: 'Categoria: ',
    detailsAlcoholicEN: 'Alcohol: ',
    detailsAlcoholicES: 'Alcohol: ',
    detailsAlcoholicDE: 'Alkohol: ',
    detailsAlcoholicFR: 'Alcool : ',
    detailsAlcoholicIT: 'Alcool: ',
    detailsGlassEN: 'Glass: ',
    detailsGlassES: 'Vaso: ',
    detailsGlassDE: 'Glas: ',
    detailsGlassFR: 'Verre : ',
    detailsGlassIT: 'Bicchiere: ',
    detailsIngredientsEN: 'Ingredients:',
    detailsIngredientsES: 'Ingredientes:',
    detailsIngredientsDE: 'Zutaten:',
    detailsIngredientsFR: 'Ingrédients :',
    detailsIngredientsIT: 'Ingredienti:',
    detailsInstructionsEN: 'Instructions:',
    detailsInstructionsES: 'Instrucciones:',
    detailsInstructionsDE: 'Anweisungen:',
    detailsInstructionsFR: 'Instructions :',
    detailsInstructionsIT: 'Istruzioni:',
    goToBtnEN: 'Go to:',
    goToBtnES: 'Ir a:',
    goToBtnDE: 'Gehe zu:',
    goToBtnFR: 'Aller à :',
    ...
    RandomDrinksBtnEN: 'Random Drinks',
    RandomDrinksBtnES: 'Bebidas Aleatorias',
    RandomDrinksBtnDE: 'Zufällige Getränke',
    RandomDrinksBtnFR: 'Boissons Aléatoires',
    RandomDrinksBtnIT: 'Bevande Casuali',
    loadingEN: 'Loading...',
    loadingES: 'Cargando...',
    loadingDE: 'Laden...',
  ...
  ngOnInit(){
    if(this.language.valueChanges){
      this.language.valueChanges.subscribe(newValue => {
        this.drinkDetailsIfChangeLanguage();
    });
    }
        ...
        next: drinkDetails => {
          ...
          if(this.language.value === 'English'){
            if(this.drinkDetails.strInstructions !== null){
              ...
              this.instructionsEN = this.drinkDetailsView.noTranslationEN;
            }
          }
          if(this.language.value === 'Español'){
            if(this.drinkDetails.strInstructionsES !== null){
              ...
              this.instructionsES = this.drinkDetailsView.noTranslationES;
            }
          }
          if(this.language.value === 'Deutsch'){
            if(this.drinkDetails.strInstructionsDE !== null){
              ...
              this.instructionsDE = this.drinkDetailsView.noTranslationDE;
            }
          }
          if(this.language.value === 'Français'){
            if(this.drinkDetails.strInstructionsFR !== null){
              ...
              this.instructionsFR = this.drinkDetailsView.noTranslationFR;
            }
          }
          if(this.language.value === 'Italiano'){
            if(this.drinkDetails.strInstructionsIT !== null){
              ...
              this.instructionsIT = this.drinkDetailsView.noTranslationIT;
            }
          }
          if(this.drinkDetails.strInstructions === null &&
