...
@Component({
  selector: 'app-random-alcoholic-drink',
  templateUrl: './random-alcoholic-drink.component.html',
  styleUrls: ['./random-alcoholic-drink.component.scss']
})
export class RandomAlcoholicDrinkComponent implements OnInit {
  ...
  randomView: RandomDrinkView = {
    randomTitlePageEN: 'Random Alcoholic Drink',
    randomTitlePageES: 'Bebida alcohólica aleatoria',
    randomTitlePageDE: 'Zufälliges alkoholisches Getränk',
    randomTitlePageFR: 'Boisson alcoolisée aléatoire',
    randomTitlePageIT: 'Bevanda Alcolica Casuale',
  ...
  ngOnInit(){
    if(this.language.valueChanges){
      this.language.valueChanges.subscribe(newValue => {
        this.randomAlcoholicDrinkDetailsIfChangeLanguage();
    });
    }
    this.loadRandomAlcoholicDrinkDetails();
  }

  loadRandomAlcoholicDrinkDetails(){
    this.loading = true;
    this.instructions = '';
    this.ingredients = [];
    this.measures = [];
  ...
  randomAlcoholicDrinkDetailsIfChangeLanguage(){
    this.instructionsEN = '';
    this.instructionsES = '';
    this.instructionsDE = '';
    this.instructionsFR = '';
